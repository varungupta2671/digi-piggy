...
import { Wallet, CreditCard, Plus, Trash2, Check, Star, Shield, Smartphone, Building2 } from 'lucide-react';
            ...
            <div className="max-w-2xl mx-auto px-4 pt-4 md:pt-8">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 dark:text-slate-400">Manage your linked accounts & payment methods</p>
                    </div>
                </div>
                ...
                {!showForm && (
                    <button
                        ...
                        className="w-full py-4 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl flex items-center justify-center gap-2 text-slate-500 dark:text-slate-400 font-bold hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-indigo-200 hover:text-indigo-500 transition-all mb-8"
                    >
                ...
                {showForm && (
                    <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 mb-8 animate-scale-in relative overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide mb-2">Account Label</label>
                                <input
                                    className="input"
                                    placeholder="e.g. Personal Savings, Salary Acct"
                                    value={name}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide mb-2">UPI ID (VPA)</label>
                            ...
                            <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-900 rounded-xl cursor-pointer" onClick={() => setIsDefault(!isDefault)}>
                                ...
                                <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Set as default payment method</span>
                            </div>
                ...
                <div className="space-y-4">
                    {accounts.length > 0 && <h3 className="font-bold text-slate-900 dark:text-white px-2">Your Accounts</h3>}
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                {isDefaultAccount && (
                                                    <span className="px-2 py-0.5 bg-indigo-100 text-indigo-700 text-[10px] font-bold uppercase rounded-full tracking-wider">Default</span>
                                                )}
                                            </div>
                    ...
                    {accounts.length === 0 && !showForm && (
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">No Wallet Connected</h3>
                            <p className="text-slate-500 max-w-xs mx-auto">Link a UPI account to start saving seamlessly towards your goals.</p>
                        </div>
                    )}
                </div>
            </div>
